...
I have not restricted the stepsize. However, if you set it to be more than 1 with a sufficient amount of iterations, it will likely result in very strange or "broken" results.
