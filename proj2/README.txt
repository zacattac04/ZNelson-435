...
This program will read the information from an NFF file, and use ray tracing to create a PPM file. It will take into account specular and diffuse components, and will be able to show basic shading, shadows, and reflections based on point lights.
